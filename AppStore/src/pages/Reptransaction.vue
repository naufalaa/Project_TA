<template>
  <q-page>
    <q-toolbar class="q-pl-md q-pr-md bgtitle">
      ...
      <q-toolbar-title>
        <span class="text-primary">LAPORAN</span> TRANSAKSI
      </q-toolbar-title>
      <q-space />
            ...
            >
              <template v-slot:body="props">
                <q-tr :props="props">
                  ...
                  <q-td auto-width key="datetr" :props="props">{{ formatDate(props.row.datetr) }}</q-td>
                  ...
                  <q-td
                    key="total"
                    :props="props"
                  >Rp&nbsp;{{ formatPrice(parseFloat(props.row.subtotal) + parseFloat(props.row.couriercost) + parseFloat(props.row.uniquecode)) }}</q-td>
                  ...
                  <q-card-section>
                    ...
                    <div class="row">
                      ...
                      <div
                        class="col-8 text-weight-bold"
                        align="right"
                      >Rp{{ formatPrice(formupdate.transfer) }}</div>
                    </div>
                  </q-card-section>
                </q-card>
              </div>
...
export default {
  name: 'Reptransaction',
  preFetch ({ store }) {
    store.dispatch('transactions/getreptransaction')
  },
  directives: {
